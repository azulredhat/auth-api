...
describe('DeleteReplyUseCase', () => {
  it('should orchestrating the delete comment action correctly', async () => {
    ...
    expect(mockCommentRepository.checkCommentAvailability)
      .toHaveBeenCalledWith( useCaseParams.commentId, useCaseParams.threadId );
    expect(mockReplyRepository.checkReplyAvailability)
      .toHaveBeenCalledWith( useCaseParams.replyId, useCaseParams.commentId );
    expect(mockReplyRepository.verifyReplyOwner)
      .toHaveBeenCalledWith( useCaseParams.replyId, 'user-123' );
